...
public class TgaFooter
{
    ...
    /// </exception>
    public TgaFooter(BinaryReader reader)
    {
    ...
    public static bool HasFooter(BinaryReader reader)
    {
        ...
        try
        {
            string signature = ReadSignature(reader);
    ...
    public override string ToString()
    {
        ...
        sb.Append($"ExtensionAreaOffset     : {ExtensionAreaOffset}\r\n");
        sb.Append($"DeveloperDirectoryOffset: {DeveloperDirectoryOffset}\r\n");
    ...
    private static string ReadSignature(BinaryReader reader)
    {
        ...
        int signatureSize = (FieldLength.Signature + FieldLength.ReservedCharacter + FieldLength.BinaryZeroStringTerminator);
